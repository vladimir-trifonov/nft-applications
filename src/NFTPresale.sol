 ...
 * https://sepolia.etherscan.io/tx/0x4639465359910b154516c11ec4f07a36e1e089a54cc7df7d84136babfb6c17bf
 */
contract NFTPresale is ERC721, IERC2981, Ownable {
  ...
  uint256 constant PRESALE_PRICE = 500_000;
  ...
  /**
    ...
    * @return A true if the contract supports the interface, false otherwise
    */
  ...
  function tokenURI(
    ...
    return string(abi.encodePacked(_baseURI(), matedataIndex.toString(), ".json"));
  }
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmcnsDPCkUWCxFknXCgeJwKK9WbfeEa7ukVjEc35fgjf7R/";
  }
